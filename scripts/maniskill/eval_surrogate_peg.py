...
if __name__ == "__main__":
    ...
    def run_experiment(params):
        ...
        cfg = {
            ...
            'actor_kwargs': {actor_param_names[actor_type]: hyper_value, 'seed': 42},
            'num_episode': 30,
            'root_dir': root_dir,
            ...
            'device': 'cuda:1',
            # 'expert_model': "${root_dir}/model_param/weight/peg_expert/PPO_Peg/2025-03-27/09-22-02/SimplePegInsertion-v1__PPO_Peg__4322.actor_critic.pth",
            'expert_model': "${root_dir}/model_param/weight/peg_expert/PPO_Peg/best/SimplePegInsertion-v1__PPO_Peg__4322.actor_critic.pth",
            'task': 'test_sweep',  
