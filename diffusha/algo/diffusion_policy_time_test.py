...
class DDPMPolicy:
    ...
    def act(self,obs,user_action):
        ...
        file_path = f'result_analysis/time_ana/time_table/ddpm_{TIME_NAME}.csv'
...
class JointConditionPolicy:
    ...
    def act(self,obs,user_action,deterministic=True):
        ...
        end_time = time.time()
        if self.use_predict_next_state:
            file_path = f'result_analysis/time_ana/time_table/cm_next_{TIME_NAME}.csv'
        else:
            file_path =f'result_analysis/time_ana/time_table/cm_{TIME_NAME}.csv'
